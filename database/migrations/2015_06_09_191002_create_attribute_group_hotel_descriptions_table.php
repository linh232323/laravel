...
class CreateAttributeGroupHotelDescriptionsTable extends Migration {
	...
	public function up()
	{
		Schema::create('attribute_group_hotel_descriptions', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('attribute_group_hotel_descriptions');
	}
