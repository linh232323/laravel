...
<div class="panel-body">
          {!!Form::open(array('route'=>'room_create_post','id'=>'form-category','files'=>true,'class'=>'form-horizontal'))!!}
	            ...
	            <div class="content">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            @else
                            <input type="text" name="maxadults" value="1" placeholder="Max Adults" id="input-maxadults" class="form-control">
                            @endif
                        </div>
                    </div>
				    <div class="form-group required">
