@extends('admin.admin')
@section('content')
          {!!Form::model($data,array('route'=>array('admin.user.update',$data->id),'method'=>'PUT','id'=>'form-user','class'=>'form-horizontal' ,'files'=>true))!!}
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-oldpassword">Old Password</label>
            <div class="col-sm-10">
              {!!Form::password('oldpassword',array("placeholder"=>"Old Password", "id"=>"input-oldpassword", "class"=>"form-control"))!!}
            </div>
          </div>
          <div class="form-group required">
