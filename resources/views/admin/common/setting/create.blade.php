...
<div class="panel-body">
          {!!Form::open(array('route'=>'admin.setting.store','id'=>'form-setting','files'=>true,'class'=>'form-horizontal'))!!}
            ...
            <div class="tab-pane" id="tab-local">
              <div class="content">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    @if(Input::old('zone_id'))
                    {!!Form::select('zone_id', $zone_id, Input::old('zone_id'), array( "id"=>"input-zone_id", "class"=>"form-control"))!!}
                    @else
                    {!!Form::select('zone_id', $zone_id, 30, array( "id"=>"input-zone_id", "class"=>"form-control"))!!}
                    @endif
                  </div>
                </div>
              </div>
