...
<div class="panel-body">
          {!!Form::open(array('route'=>'admin.hotel.store','id'=>'form-hotel','files'=>true,'class'=>'form-horizontal'))!!}
	        ...
	        <div class="tab-pane fade" id="tab-data">
	            <div class="content">
				        ...
				        <div class="col-sm-10">
				            	...
				            	<div>
						            <label class="radio-inline">
						            	@if(Input::old('star')==$i||Input::old('star')=="")
				    ...
				    <div class="form-group required">
				        ...
				        <div class="col-sm-10">
              				{!!Form::select('wifi', array('0' => 'Yes', '1' => 'No'),Input::old('wifi'),array( "id"=>"input-status", "class"=>"form-control"))!!}
				        </div>
				    </div>
				    <div class="form-group required">
				    ...
				    <div class="form-group required">
				        ...
				        <div class="col-sm-10">
				            <select name="status" id="input-status" class="form-control">
				            	@if(Input::old('status')==0||Input::old('status')=="")
	            ...
	            <div class="content">
				    <div class="col-sm-12">
				        <div class="form-group required">
				            ...
				            <div class="col-sm-4">
              					{!!Form::text('maps_apil',Input::old('maps_apil'),array("placeholder"=>"API", "min"=>"0", "id"=>"input-maps_apil", "class"=>"form-control"))!!}
				            </div>
				            <div class="col-sm-4">
          						{!!Form::text('maps_apir',Input::old('maps_apir'),array("placeholder"=>"API", "min"=>"0", "id"=>"input-maps_apir", "class"=>"form-control"))!!}
				            </div>
				        </div>
				    </div>
				</div>
